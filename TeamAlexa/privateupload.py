...
async def photo_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            "🌹 ꜰɪʟᴇ ᴍᴜsᴛ ʙᴇ ʟᴇss ᴛʜᴀɴ 5ᴍʙ, ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɴᴏᴛʜᴇʀ ꜰɪʟᴇ ᴀʟsᴏ 👉 <a href=https://t.me/Uploder_N1bot>LEARN THIS BOT FIRST!</a>",
...
async def animation_upload(bot, message):
    ...
    try:
        ...
        await msg.edit_text(
            "🌹 ꜰɪʟᴇ ᴍᴜsᴛ ʙᴇ ʟᴇss ᴛʜᴀɴ 5ᴍʙ, ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɴᴏᴛʜᴇʀ ꜰɪʟᴇ ᴀʟsᴏ 👉 <a href=https://t.me/Abo_Hadieda>❤️ ᴄᴏᴍᴇ ᴀɴᴅ ɪɴᴄʀᴇᴀsᴇ ʜᴇᴀʀᴛ ❤️</a>",
